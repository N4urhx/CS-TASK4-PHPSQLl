...
<body>
    <div class="container">
       ...
       <form action="submit_review.php" method="POST">
            ...
            <input type="text" id="username" name="username" placeholder="Auni Qaisara" required>

            <label for="email">Email:</label>
            <input type="email" id="email" name="email" placeholder="naurrni@gmail.com" required>
